...
mongoose.connect(
  "mongodb+srv://admin-yush:yushajay1@cluster0.x2h7y.mongodb.net/NewDb?retryWrites=true&w=majority",
  {
...
app.get("/aboutus", function (req, res) {
  let namesent;
  if (currentUser == null) namesent = "";
  else namesent = currentUser.username;
  ...
  Donor.find(
    {
      ...
      "details.city": currentReceiver.city,
    },
...
app.get("/receiverList", (req, res) => {
  ...
  Receiver.find(
    {
      "details.bloodGroup": {
        $in: bldGrpChartForDonor[currentUser.bloodGroup],
      },
    ...
    function (err, results) {
      if (!err) {
        ...
        res.render("list2", {
          ...
          age: age,
          text1:
            "You are doing a fabulous job. Here are some people you can help",
                  ...
                  function (err, result) {
                    if (result) {
                      ...
                      const newUser = new User({
                        name:
                          _.upperFirst(_.toLower(ans.first_name)) +
                          " " +
                          _.upperFirst(_.toLower(ans.last_name)),
